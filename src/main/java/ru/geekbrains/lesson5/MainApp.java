...
public class MainApp {
    ...
    public static void firstMethod() {
        ...
        System.out.println("1.Время обработки массива одним потоком " + (System.currentTimeMillis() - startTime) + " ms.");
    }


    private static void secondMethod() {
        System.out.println("2. Обработка массива при помощи двух потоков:");
        arrayFill();
